...
public class UpdateFileList {
    ...
    private String doNotCopyList = "updateDoNotCopyOverList";
    ...
    private void parseArgument(String arg) {
        ...
        else if (arg.startsWith("-updateList:"))
            updateList = arg.substring(12);
        else if (arg.startsWith("-doNotCopyList:"))
            doNotCopyList = arg.substring(15);
        else
    ...
    public File createDoNotUpdateList() {
        ...
        return FileUtil.createFile(new File(doNotCopyList), updateDoNotCopyOverContent);
    }
}
