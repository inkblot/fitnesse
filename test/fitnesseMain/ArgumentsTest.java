...
public class ArgumentsTest {
    ...
    public void testSimpleCommandline() throws Exception {
        FitNesseMain.Arguments args = FitNesseMain.parseCommandLine();
        assertNotNull(args);
    ...
    public void testArgumentsAlternates() throws Exception {
        ...
        FitNesseMain.Arguments args = FitNesseMain.parseCommandLine(argString.split(" "));
    ...
    public void testAllArguments() throws Exception {
        FitNesseMain.Arguments args = FitNesseMain.parseCommandLine("-p", "81", "-d", "directory", "-r", "root", "-l", "myLogDirectory", "-o", "-e", "22");
        assertNotNull(args);
    ...
    public void testNotOmitUpdates() throws Exception {
        FitNesseMain.Arguments args = FitNesseMain.parseCommandLine("-p", "81", "-d", "directory", "-r", "root", "-l", "myLogDirectory");
        assertNotNull(args);
        assertEquals(81, args.getPort());
        assertEquals("directory", args.getRootPath());
        assertEquals("root", args.getRootDirectory());
    ...
    public void commandShouldUseDifferentDefaultPort() throws Exception {
        FitNesseMain.Arguments args = FitNesseMain.parseCommandLine("-c", "someCommand");
        assertNotNull(args);
    ...
    public void commandShouldAllowPortToBeSet() throws Exception {
        FitNesseMain.Arguments args = FitNesseMain.parseCommandLine("-c", "someCommand", "-p", "666");
        assertNotNull(args);
    ...
    public void testBadArgument() throws Exception {
        FitNesseMain.Arguments args = FitNesseMain.parseCommandLine("-x");
        assertNull(args);
    }
}
