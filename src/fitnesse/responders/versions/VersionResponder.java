...
public class VersionResponder implements SecureResponder {
    ...
    @Inject
    public VersionResponder(HtmlPageFactory htmlPageFactory, @Named(WikiModule.ROOT_PAGE) WikiPage root) {
    ...
    public Response makeResponse(Request request) throws Exception {
        ...
        if (version == null)
            return new ErrorResponder("No version specified.", htmlPageFactory).makeResponse(request);
