...
public class WidgetBuilderTest extends FitnesseBaseTestCase {
    ...
    public void testEmptyPage() throws Exception {
        ParentWidget widget = new WidgetRoot(null, mockSource, WidgetBuilder.htmlWidgetBuilder);
    ...
    public void testSimpleText() throws Exception {
        ParentWidget page = new WidgetRoot("Hello, World!", mockSource, WidgetBuilder.htmlWidgetBuilder);
        assertNotNull(page);
    ...
    public void testSimpleWikiWord() throws Exception {
        ParentWidget page = new WidgetRoot("WikiWord", mockSource, WidgetBuilder.htmlWidgetBuilder);
        WikiWidget widget = page.nextChild();
    ...
    public void testTextThenWikiWord() throws Exception {
        ParentWidget page = new WidgetRoot("text WikiWord more Text", mockSource, WidgetBuilder.htmlWidgetBuilder);
    ...
    public void testWikiWord_Text_WikiWord() throws Exception {
        ParentWidget page = new WidgetRoot("WikiWord more WordWiki", mockSource, WidgetBuilder.htmlWidgetBuilder);
        assertEquals(3, page.numberOfChildren());
        WikiWidget widget1 = page.nextChild();
        WikiWidget widget2 = page.nextChild();
        WikiWidget widget3 = page.nextChild();
    ...
    public void testItalic_text_WikiWord() throws Exception {
        ParentWidget page = new WidgetRoot("''italic'' text WikiWord", mockSource, WidgetBuilder.htmlWidgetBuilder);
        assertEquals(3, page.numberOfChildren());
        WikiWidget widget1 = page.nextChild();
        WikiWidget widget2 = page.nextChild();
        WikiWidget widget3 = page.nextChild();
    ...
    public void testMultiLineWidget() throws Exception {
        ParentWidget page = new WidgetRoot("{{{\npreformatted\n}}}", mockSource, WidgetBuilder.htmlWidgetBuilder);
        assertEquals(1, page.numberOfChildren());
    ...
    public void testEmailWidget() throws Exception {
        ParentWidget page = new WidgetRoot("someone@somewhere.com", mockSource, WidgetBuilder.htmlWidgetBuilder);
        assertEquals(1, page.numberOfChildren());
    ...
    public void testHrule() throws Exception {
        ParentWidget page = new WidgetRoot("-----", mockSource, WidgetBuilder.htmlWidgetBuilder);
        WikiWidget widget = page.nextChild();
    ...
    public void testAnchorsMarker() throws Exception {
        ParentWidget page = new WidgetRoot(".#name ", mockSource, WidgetBuilder.htmlWidgetBuilder);
        WikiWidget widget = page.nextChild();
    ...
    public void testAnchorsDeclaration() throws Exception {
        ParentWidget page = new WidgetRoot("!anchor name ", mockSource, WidgetBuilder.htmlWidgetBuilder);
        WikiWidget widget = page.nextChild();
    ...
    public void testClasspath() throws Exception {
        ParentWidget page = new WidgetRoot("!path something", mockSource, WidgetBuilder.htmlWidgetBuilder);
        assertEquals(1, page.numberOfChildren());
    ...
    public void testNoteWidget() throws Exception {
        ParentWidget page = new WidgetRoot("!note something", mockSource, WidgetBuilder.htmlWidgetBuilder);
        assertEquals(1, page.numberOfChildren());
    ...
    public void testNullPointerError() throws Exception {
        ...
        ParentWidget root = new WidgetRoot(wikiText, new WikiPageDummy(injector), WidgetBuilder.htmlWidgetBuilder);
    ...
    public void testVirtualWikiWidget() throws Exception {
        ParentWidget page = new WidgetRoot("!virtualwiki http://localhost/FrontPage", mockSource, WidgetBuilder.htmlWidgetBuilder);
        assertEquals(1, page.numberOfChildren());
...
//    @Test
    public void testLargeTable() throws Exception {
        ...
        try {
            ParentWidget root = new WidgetRoot(buffer.toString(), new WikiPageDummy(injector), WidgetBuilder.htmlWidgetBuilder);
            root.render();
    ...
    private void testWikiWordInParentWidget(String input, Class<?> expectedClass, String wikiWordText, int subChildren) throws Exception {
        ParentWidget page = new WidgetRoot(input, mockSource, WidgetBuilder.htmlWidgetBuilder);
        assertEquals(1, page.numberOfChildren());
        WikiWidget widget = page.nextChild();
    ...
    public void testParsingManyLineBreaksIsFast() throws Exception {
        ...
        ParentWidget root = new WidgetRoot(b.toString(), mockSource, WidgetBuilder.htmlWidgetBuilder);
