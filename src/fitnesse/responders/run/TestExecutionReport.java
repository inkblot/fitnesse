...
public class TestExecutionReport extends ExecutionReport {
    ...
    public TestExecutionReport(InputStream input) throws IOException {
        xmlDoc = XmlUtil.newDocument(input);
        unpackXml();
    }

    public TestExecutionReport(String string) throws IOException {
    ...
    public TestExecutionReport read(File file) throws IOException {
