...
public class UpdateFileListTest {
    ...
    public void shouldKnowWhichSpecialFilesNotToInclude() throws Exception {
        ...
        assertDoesNotHaveRegexp("TestFolder/fitnesse.css", content);
        assertDoesNotHaveRegexp("TestFolder/fitnesse_print.css", content);
    }
    ...
    public void shouldPutSpecialFilesInDifferentList() throws Exception {
        ...
        assertDoesNotHaveRegexp("TestFolder/TestFile", doNotUpdateContent);
    }
    ...
    public void shouldPrunePrefixes() throws Exception {
        ...
        assertDoesNotHaveRegexp("TestFolder/TestFile", content);
    }
