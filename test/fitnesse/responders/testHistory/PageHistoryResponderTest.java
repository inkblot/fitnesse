...
public class PageHistoryResponderTest extends FitnesseBaseTestCase {
    ...
    @Inject
    public void inject(HtmlPageFactory htmlPageFactory, @Named(FitNesseModule.TEST_RESULTS_PATH) String testResultsPath) {
    ...
    public void setup() throws Exception {
        ...
        responder = new PageHistoryResponder(htmlPageFactory, testResultsPath);
    ...
    private PageHistory.PassFailBar computePassFailBarFor(int right, int wrong, int ignores, int exceptions) throws IOException, ParseException {
        ...
        return pageHistory.getPassFailBar(date, 50);
    }
    ...
    public void shouldNotReportNoHistoryIfHistoryIsPresent() throws Exception {
        ...
        makeResponse();
        RegexAssertions.assertDoesNotHaveRegexp("No history for page: TestPage", response.getContent());
    }
